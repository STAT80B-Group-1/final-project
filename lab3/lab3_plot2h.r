...
hist(cleaned_data$unsheltered_homeless_2017, main = "Distribution of total unsheltered homeless count in California in 2017", xlab = "Total unsheltered homeless in 2017", ylab = "Count")
