...
hist(cleaned_data$sheltered_homeless_2017, main = "Distribution of total sheltered homeless count in California in 2017", xlab = "Total sheltered homeless in 2017", ylab = "Count")
