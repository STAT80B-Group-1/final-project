...
hist(cleaned_data$unsheltered_homeless_2007, main = "Distribution of total unsheltered homeless count in California in 2007", xlab = "Total unsheltered homeless in 2007", ylab = "Count")